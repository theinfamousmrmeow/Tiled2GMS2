...
<tileset version="1.2" tiledversion="1.2.3" name="FishDude_pink_jump" tilewidth="16" tileheight="16" tilecount="9" columns="9">
 <image source="../../Fish/FishDude_pink_jump.png" width="144" height="16"/>
 <tile id="0">
  <animation>
