...
<tileset version="1.2" tiledversion="1.2.3" name="riverFlow" tilewidth="16" tileheight="16" tilecount="60" columns="12">
 <image source="../../TileSet/riverFlow.png" width="192" height="80"/>
 <tile id="0">
  <animation>
