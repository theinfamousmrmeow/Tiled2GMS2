...
<tileset version="1.2" tiledversion="1.2.3" name="waterfalls" tilewidth="16" tileheight="16" tilecount="36" columns="12">
 <image source="../Images/waterfalls.png" width="192" height="48"/>
 <tile id="0">
  <animation>
